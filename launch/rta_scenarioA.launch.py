...
"""
This launch file sets up the RTA scenario A, which consists of a single VTOL drone (PX4 SITL) and the Micro XRCE Agent.
This scenario sets up the Aileron failure test, where the drone will experience a failure in the aileron control surface,
and the RTA system will need to detect and mitigate the failure to maintain safe flight.

The vehicle takes off and performs a figure 8 pattern.
"""
